...
Gem::Specification.new do |s|
  ...
  s.files = ["CHANGELOG.adoc", "CONTRIBUTING.adoc", "LICENSE", "bin/asciidoctor", "bin/asciidoctor-safe"]
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_development_dependency(%q<nokogiri>, ["~> 1.8.0"])
      ...
      s.add_dependency(%q<nokogiri>, ["~> 1.8.0"])
